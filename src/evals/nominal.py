#nominal.py
#This script is by Shaked Zychlinski (https://github.com/shakedzy)
#Source: https://github.com/shakedzy/dython/blob/master/dython/nominal.py
#Relevant Medium post: https://medium.com/@outside2SDs/an-overview-of-correlation-measures-between-categorical-and-continuous-variables-4c7f85610365
#Note that:
#identify_columns_by_type is from https://github.com/shakedzy/dython/blob/master/dython/data_utils.py
#convert, remove_incomplete_samples, and replace_nan_with_value are from https://github.com/shakedzy/dython/blob/master/dython/_private.py
...
#https://github.com/shakedzy/dython/blob/master/dython/data_utils.py
...
#https://github.com/shakedzy/dython/blob/master/dython/_private.py
def convert(data, to):
    converted = None
    if to == 'array':
