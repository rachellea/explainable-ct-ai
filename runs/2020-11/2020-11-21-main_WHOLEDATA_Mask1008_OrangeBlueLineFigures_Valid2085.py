...
from plot import viz_redbluelines

if __name__=='__main__':
    tot0 = timeit.default_timer()
    m = viz_redbluelines.MakeRedBlueLineVisualizations(descriptor='WHOLEDATA_Mask1008_RedBlueLineFigures',
                ...
                results_dir='/storage/rlb61-data/img-hiermodel2/results/2020-11-21_WHOLEDATA_Mask1008_RedBlueLineFigures/')
    m.run_model()
