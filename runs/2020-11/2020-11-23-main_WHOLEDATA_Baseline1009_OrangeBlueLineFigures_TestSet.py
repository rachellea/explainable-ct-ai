...
if __name__=='__main__':
    ...
    m = viz_orangebluelines.MakeLineVisualizations(descriptor='WHOLEDATA_Baseline1009_OrangeBlueLineFigures_TestSet',
                custom_net = custom_models_mask.BodyAvg_Mask,
                custom_net_args = {'n_outputs':80,'slices':135},
                batch_size = 1, device = 0,
                full_params_dir ='/storage/rlb61-data/img-hiermodel2/results/2020-10/2020-10-09_WHOLEDATA_BodyAvg_Baseline_FreshStart/params/WHOLEDATA_BodyAvg_Baseline_FreshStart_epoch4',
                ...
                results_dir='/storage/rlb61-data/img-hiermodel2/results/2020-11-23_WHOLEDATA_Baseline1009_OrangeBlueLineFigures_TestSet') #for None, results dir will be initialized based on descriptor
    m.run_model()
