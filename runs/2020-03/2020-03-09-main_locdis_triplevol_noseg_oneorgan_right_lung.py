...
if __name__=='__main__':
    ...
    DukeCTModel(descriptor='locdis_triplevol_noseg_oneorgan_right_lung',
                custom_net = custom_models_loc.ResNet18_TripleCrop_NoSeg_OneOrgan,
                custom_net_args = {'n_outputs_organ':28,'organ_name':'right_lung'},
                loss = 'bce', loss_args = {}, #or empty dict
                num_epochs=100, patience = 15,
                batch_size = 1, device = 3, data_parallel = False,
                model_parallel = False,
                use_test_set = False, task = 'train_eval',
                old_params_dir = '',
                dataset_class = custom_datasets.CTDataset_2019_10,
                dataset_args = {'label_type_ld':'right_lung',
