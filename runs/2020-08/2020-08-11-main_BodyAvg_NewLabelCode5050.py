...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='BodyAvg_NewLabelCode5050',
                custom_net = custom_models_base.Body_Avg,
                custom_net_args = {'n_outputs':156},
                loss_string = 'bce',
                ...
                dataset_args = {'label_type_ld':'location_disease_0323',
                                'label_counts':{'mincount_heart':50, #default 200
                                                'mincount_lung':50}, #default 125
                                'view':'axial',
                                'projections9':True,
