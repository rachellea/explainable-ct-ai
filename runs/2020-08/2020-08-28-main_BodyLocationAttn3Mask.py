...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='BodyLocationAttn3Mask',
                custom_net = custom_models_mask.BodyLocationAttn3Mask,
                custom_net_args = {'n_outputs_lung':51,'n_outputs_heart':30}, #I FIXED THIS!!! In the run from 8/27 it was wrong!!!
                loss_string = 'BodyLocationAttn3Mask-loss',
