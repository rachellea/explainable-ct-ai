...
if __name__=='__main__':
    runs = {'BodyAvgSelfSup5':'bce-selfsup-schedule5',
            'BodyAvgSelfSup6':'bce-selfsup-schedule6',
            'BodyAvgSelfSup7':'bce-selfsup-schedule7',
            'BodyAvgSelfSup8':'bce-selfsup-schedule8',
            'BodyAvgSelfSup9':'bce-selfsup-schedule9',
            'BodyAvgSelfSup10':'bce-selfsup-schedule10',
            'BodyAvgSelfSup11':'bce-selfsup-schedule11'}
    for descriptor in list(runs.keys()):
        loss_string = runs[descriptor]
        tot0 = timeit.default_timer()
        DukeCTExperiment(descriptor=descriptor,
