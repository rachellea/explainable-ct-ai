...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='WHOLEDATA_BodyAvg_Baseline',
        ...
        old_params_dir = '/home/rlb61/data/img-hiermodel2/results/2020-10-06_WHOLEDATA_BodyAvg_Baseline/params/',
