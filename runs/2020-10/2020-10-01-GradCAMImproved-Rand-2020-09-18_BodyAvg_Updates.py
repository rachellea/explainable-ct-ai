    ...
    def run_model(self, x):
        ...
        for name, module in conv2d:
            ...
            if name in self.target_layers: #names are e.g. '4'. target_layers can be e.g. ['2','4']
                ...
                target_activations[name] = x.cpu().data #TODO is it okay to transfer to CPU here or do I have to wait? i.e. does it make a copy (in which case it is ok) or does it delete from gpu?
...
if __name__ == '__main__':
    gradcam_improved.RunGradCam(descriptor='Rand-2020-09-18_BodyAvg_Updates',
                gradcamclass = gradcam_improved.GradCam,
