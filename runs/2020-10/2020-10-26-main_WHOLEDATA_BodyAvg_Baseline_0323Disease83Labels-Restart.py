...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='WHOLEDATA_BodyAvg_Baseline_0323Disease83Labels',
        custom_net = custom_models_base.BodyAvg,
        custom_net_args = {'n_outputs':83}, #80 labels (now that I've removed heart_nodule)
        loss_string = 'bce',
        loss_args = {},
        ...
        old_params_dir = '/storage/rlb61-data/img-hiermodel2/results/2020-10-26_WHOLEDATA_BodyAvg_Baseline_0323Disease83Labels/params/',
