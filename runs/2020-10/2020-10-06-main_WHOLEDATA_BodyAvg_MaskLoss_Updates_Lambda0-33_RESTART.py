...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='WHOLEDATA_BodyAvg_Mask_dilate'+str(dilate)+'_'+downsamp_mode+'_Lambda33',
        ...
        old_params_dir = '/home/rlb61/data/img-hiermodel2/results/2020-10-06_WHOLEDATA_BodyAvg_Mask_dilateFalse_nearest_Lambda33/params/',
