...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='WHOLEDATA_OldCTNet_Retry',
        ...
        old_params_dir = '/storage/rlb61-data/img-hiermodel2/results/2020-10-24_WHOLEDATA_OldCTNet_Retry/params/',
