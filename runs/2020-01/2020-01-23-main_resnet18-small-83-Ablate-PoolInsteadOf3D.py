...
from custom_models import ResNet18_Batch_Ablate_PoolInsteadOf3D
from custom_datasets import CTDataset_2019_10

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='resnet18-small-83-Ablate-PoolInsteadOf3D',
                custom_net = ResNet18_Batch_Ablate_PoolInsteadOf3D,
