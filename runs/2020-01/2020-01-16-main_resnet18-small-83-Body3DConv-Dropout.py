...
from custom_models import ResNet18_Batch_Body3DConv_Dropout
from custom_datasets import CTDataset_2019_10

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='resnet18-small-83-Body3DConv-Dropout',
                custom_net = ResNet18_Batch_Body3DConv_Dropout,
