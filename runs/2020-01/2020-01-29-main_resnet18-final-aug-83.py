...
from ct_img_model2 import DukeCTModel
...
if __name__=='__main__':
    ...
    DukeCTModel(descriptor='resnet18-final-aug-83',
                ...
                old_params_dir = '/home/rlb61/data/img-hiermodel2/results/2019-12-24_resnet18-final-aug-83/params/', #only needed if task is 'predict_on_test'
