...
from custom_models import ResNet18_Batch_Body3DConv_MaxPool
from custom_datasets import CTDataset_2019_10

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='resnet18-small-83-Body3DConv-MaxPool',
                custom_net = ResNet18_Batch_Body3DConv_MaxPool,
                custom_net_args = {'n_outputs':83},
                num_epochs=100,
                patience = 15, batch_size = 4,
                device = 'all', loss = 'bce',
