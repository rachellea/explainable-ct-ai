...
from custom_models import ResNet18Less_Batch_Body3DConv
from custom_datasets import CTDataset_2019_10

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='resnet18less-small-83-Body3DConv',
                custom_net = ResNet18Less_Batch_Body3DConv,
