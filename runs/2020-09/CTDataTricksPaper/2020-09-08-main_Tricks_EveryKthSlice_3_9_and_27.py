...
if __name__=='__main__':
    for chosen_k in [3,9,27]:
        tot0 = timeit.default_timer()
        DukeCTExperiment(descriptor='Tricks-BodyAvg-SelectEvery-'+str(chosen_k)+'-Slices',
                    custom_net = custom_models_projections.BodyAvg_SelectEveryKthSlice,
                    custom_net_args = {'n_outputs':83,'chosen_k':chosen_k},
                    loss_string = 'bce',
