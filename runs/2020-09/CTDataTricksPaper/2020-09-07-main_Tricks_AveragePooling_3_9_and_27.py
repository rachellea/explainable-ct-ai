...
if __name__=='__main__':
    for projection in [3,9,27]:
        tot0 = timeit.default_timer()
        DukeCTExperiment(descriptor='Tricks-BodyAvg-'+str(projection)+'AverageProj',
                    custom_net = custom_models_projections.BodyAvg_AverageProjected,
                    custom_net_args = {'n_outputs':83,'projection':projection},
                    loss_string = 'bce',
