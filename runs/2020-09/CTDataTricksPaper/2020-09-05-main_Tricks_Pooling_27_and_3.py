...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='Tricks-BodyAvg-27Projections',
    ...
    ### 3 Projections ###
    tot0 = timeit.default_timer()
    DukeCTExperiment(descriptor='Tricks-BodyAvg-3Projections',
                custom_net = custom_models_projections.BodyAvg_Projected,
                custom_net_args = {'n_outputs':83,'projection':3},
                loss_string = 'bce',
                dataset_args = merge_dicts(SHARED_DATASET_ARGS,
                                        {'view':'axial',
