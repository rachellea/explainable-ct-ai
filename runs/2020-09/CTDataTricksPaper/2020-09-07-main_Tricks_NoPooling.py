...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='Tricks-BodyAvg-NoProjections',
                custom_net = custom_models_projections.BodyAvg_NoProjection,
                ...
                dataset_args = merge_dicts(SHARED_DATASET_ARGS,
                                        ...
                                        'volume_prep_args':{
                                                ...
                                                'num_channels':3, #NO PROJECTIONS MUST BE PROVIDED AS ALREADY 3 CHANNEL TO AVOID MEMORY ERROR
