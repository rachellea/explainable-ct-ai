...
from load_dataset import custom_datasets_NORANDPAD

#Same setup as Mask Loss UPDATES model. (no rand padding, better ground truth,
#etc.)

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTExperiment(descriptor='OldCTNet83_Updates_Full-405-Slices',
                custom_net = custom_models_old.ResNet18_Original,
                custom_net_args = {'n_outputs':80,'slices':135}, #80 labels (now that I've removed heart_nodule)
                loss_string = 'bce',
                ...
                old_params_dir = '',
                dataset_class = custom_datasets_NORANDPAD.CTDataset_2019_10,
                dataset_args = {'label_type_ld':'location_disease_0323',
                                ...
                                'view':'axial',
                                'projections9':False, #FULL 405 SLICES!!!
                                ...
                                'volume_prep_args':{
                                            ...
                                            'max_slices':405, #FULL 405 SLICES!!!
                                            'max_side_length':420,
                                            'num_channels':3,
                                            'crop_type':'single',
