...
if __name__=='__main__':
    ...
    DukeCTModel(descriptor='Body_Cll_FC',
                custom_net = custom_models_base.Body_Cll_FC,
    ...
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='Body_Avg_FC_FC',
                custom_net = custom_models_base.Body_Avg_FC_FC,
                custom_net_args = {'n_outputs':83},
                loss = 'bce', loss_args = {},
                num_epochs=100, patience = 15,
                batch_size = 1, device = 0,
    ...
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='Body_FC_FC',
                custom_net = custom_models_base.Body_FC_FC,
                custom_net_args = {'n_outputs':83},
                loss = 'bce', loss_args = {},
                num_epochs=100, patience = 15,
                batch_size = 1, device = 0,
