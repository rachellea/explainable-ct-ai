...
from models import custom_models_attn2
from load_dataset import custom_datasets

def hf():
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='Body_Cll_Avg_HFWeight',
                custom_net = custom_models_attn2.Body_Cll_Avg_HFWeight,
                custom_net_args = {'n_outputs':83,'use_attn_features':True,'use_attn_height':True},
                loss = 'bce', loss_args = {},
...
def h_only():
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='Body_Cll_Avg_HWeight',
                custom_net = custom_models_attn2.Body_Cll_Avg_HFWeight,
                custom_net_args = {'n_outputs':83,'use_attn_features':False,'use_attn_height':True},
                loss = 'bce', loss_args = {},
                num_epochs=100, patience = 15,
                batch_size = 1, device = 0,
                data_parallel = False, model_parallel = False,
...
def f_only():
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='Body_Cll_Avg_FWeight',
                custom_net = custom_models_attn2.Body_Cll_Avg_HFWeight,
                custom_net_args = {'n_outputs':83,'use_attn_features':True,'use_attn_height':False},
                loss = 'bce', loss_args = {},
                num_epochs=100, patience = 15,
                batch_size = 1, device = 0,
                data_parallel = False, model_parallel = False,
