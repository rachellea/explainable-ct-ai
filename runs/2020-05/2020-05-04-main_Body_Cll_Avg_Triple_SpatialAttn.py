...
if __name__=='__main__':
    ...
    DukeCTModel(descriptor='Body_Cll_Avg_Triple_SpatialAttn',
                custom_net = custom_models_triplecrop.Body_Cll_Avg_Triple_SpatialAttn,
                custom_net_args = {'n_outputs_lung':28,'n_outputs_heart':27,'spatial':True},
                loss = 'bce', loss_args = {},
