...
if __name__=='__main__':
    ...
    DukeCTModel(descriptor='Body_Cll_Avg_NoAug',
                custom_net = custom_models_base.Body_Cll_Avg,
                ...
                dataset_args = {'label_type_ld':'location_disease_1',
                                    ...
                                    'max_slices':45,
                                    'max_side_length':420,
                                    'data_augment':False, #Don't do data augmentation and see if that helps with right/left!
                                    'crop_type':'single',
