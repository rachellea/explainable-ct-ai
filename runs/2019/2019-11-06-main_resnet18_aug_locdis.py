...
from custom_models import ResNet18_LocDis_Flat
from custom_datasets import CTDataset_2019_10

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='resnet18-locdisflat-bigdata-aug',
                custom_net = ResNet18_LocDis_Flat,
                custom_net_args = {'n_outputs':96,
                                   'bottleneck':False,
                ...
                dataset_args = {'label_type_ld':'location_and_disease_flat',
