...
if __name__=='__main__':
    ...
    experiments = {        
        #2020-11-12_BodyAvgBase_epoch36
        '2020-11-12-Base':{'params_path_choice':'img-hiermodel2/results/2020-11-12_BodyAvgBase/params/BodyAvgBase_epoch36'}} #this is a more fair comparison than the September one because this one uses 16 num workers like all the others
