...
if __name__=='__main__':
    ...
    DukeCTExperiment(descriptor='BodyAvg_FlipRotObjective_try2',
                custom_net = custom_models_base.Body_Avg,
                custom_net_args = {'n_outputs':6},
                loss = 'bce', loss_args = {},
                
                learning_rate = 1e-1, #default 1e-3
                ...
                which_labels = 'fliprot', #can be 'all' or 'fliprot'
