...
if __name__=='__main__':
    ...
    DukeCTModel(descriptor='BodyAvgDiseaseFeatureAttn2-'+nonlinearity,
                custom_net = custom_models_diseasereps.BodyAvgDiseaseFeatureAttn2,
                custom_net_args = {'n_outputs_lung':28,'n_outputs_heart':27,'nonlinearity':nonlinearity},
                loss = 'bce', loss_args = {},
