...
from models import custom_models_attn3
from load_dataset import custom_datasets

if __name__=='__main__':
    for nonlinearity in ['sigmoid','softmax']:
        tot0 = timeit.default_timer()
        DukeCTModel(descriptor='BodyAvg_SpatialAtt3_3_Spy3D-'+nonlinearity,
                    custom_net = custom_models_attn3.BodyAvg_SpatialAtt3_3_Spy3D,
                    custom_net_args = {'n_outputs':83,'nonlinearity':nonlinearity},
                    loss = 'bce', loss_args = {},
