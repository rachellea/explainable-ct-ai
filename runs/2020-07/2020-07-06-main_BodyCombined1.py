...
from models import custom_models_combined
from load_dataset import custom_datasets

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='BodyCombined1',
                custom_net = custom_models_combined.BodyCombined1,
                ...
                dataset_args = {'label_type_ld':'location_disease_0323',
                                ...
                                'view':'all', #all views since this is multiview model
                                'projections9':True,
