...
if __name__=='__main__':
    ...
    m = MakeAttentionVisualizations(descriptor='BodyAvg_SpatialAtt3_3-softmax',
                experimentname = 'VizAttention2D',
                custom_net = custom_models_attn3.BodyAvg_SpatialAtt3_3,
                custom_net_args = {'n_outputs':83,'nonlinearity':'softmax'},
                ...
                old_params_dir = '/home/rlb61/data/img-hiermodel2/results/2020-07-17_BodyAvg_SpatialAtt3_3-softmax/params/BodyAvg_SpatialAtt3_3-softmax',
