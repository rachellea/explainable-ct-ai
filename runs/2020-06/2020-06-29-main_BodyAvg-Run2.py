...
#This is the same as the BodyAvg baseline EXCEPT that the validation set
#has data augmentation meaning that random flips etc will be applied!!!
#Therefore the validation set performance might end up being slightly lower.
#Using data augmentation in the validation set is done to get a fair
#comparison with the selfsupervised learning model.

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='BodyAvg-Run2',
