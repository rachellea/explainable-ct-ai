...
from models import custom_models_selfsupervised
from load_dataset import custom_datasets

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='BodySelfSupervised-Run2',
                custom_net = custom_models_selfsupervised.BodySelfSupervised,
                custom_net_args = {'n_outputs':83},
                loss = 'bce', loss_args = {},
                num_epochs=100, patience = 15,
                batch_size = 1, device = 0,
                data_parallel = False, model_parallel = False,
                use_test_set = False, task = 'predict_on_valid',
                old_params_dir = '/home/rlb61/data/img-hiermodel2/results/2020-06-29_BodySelfSupervised-Run2/params/',
