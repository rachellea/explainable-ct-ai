...
from models import custom_models_attn
from load_dataset import custom_datasets

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='ld_sv_Body_Fully2D_83Avg_HFAttn_P9_Spatial',
                custom_net = custom_models_attn.Body_Fully2D_83Avg_HFAttn_Spatial,
