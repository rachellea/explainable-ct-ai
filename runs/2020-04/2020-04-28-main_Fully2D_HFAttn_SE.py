...
from models import custom_models_se
from load_dataset import custom_datasets

if __name__=='__main__':
    tot0 = timeit.default_timer()
    DukeCTModel(descriptor='Fully2D_HFAttn_SE', #Swapped the order of the ReLUs and SE blocks relative to the last time I ran this model
                custom_net = custom_models_se.Body_Fully2D_83Avg_HFAttn_SE,
